...
export class AuthService {
  ...
  getJwtCookieDomain (requestHostname: string, primaryDomain: string): string {
    ...
    // if the request is from 192.168.50.242 or mysaasform.com, use the request's hostname
    if (requestHostname.endsWith('.192.168.50.242') || requestHostname.endsWith('.mysaasform.com')) { // TODO: remove hard coded value

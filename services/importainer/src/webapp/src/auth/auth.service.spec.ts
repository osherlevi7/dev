...
describe('AuthService', () => {
  ...
  describe('Cookie', () => {
    it('Cookie domain for 192.168.50.242', () => {
      const requestHostname = 'uplom.192.168.50.242'
      const primaryDomain = 'anything'
      expect(service.getJwtCookieDomain(requestHostname, primaryDomain)).toBe('uplom.192.168.50.242')
    })
    ...
    it('Cookie domain for primary not listed', () => {
      const requestHostname = 'www.uplom.com'
      const primaryDomain = 'uplom.192.168.50.242'
      expect(service.getJwtCookieDomain(requestHostname, primaryDomain)).toBe('www.uplom.com')
    })

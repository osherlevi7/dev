Feature: checkSignupRequirePayment
  ...
  Scenario: Signup and redirect to /payment, add method and redirect to SaaS, logout
    ...
    Then I expect the page url is "http://192.168.50.242:7000/payment"
    ...
    Then I expect the page url is "http://192.168.50.242:7000/"
  ...
  Scenario: User can visit home
    Given I open the url "http://192.168.50.242:7000"
    Then I expect the page url is "http://192.168.50.242:7000/"

  Scenario: User can visit settings
    Given I open the url "http://192.168.50.242:7000/user"
    Then I expect the page url is "http://192.168.50.242:7000/user"

  Scenario: User can't visit saas
    Given I open the url "http://192.168.50.242:3000"
    Then I expect the page url is "http://192.168.50.242:7000/payment"
    And I expect the element "h1" contains text "Add a payment method"

  Scenario: Login without logout
    Given I open the url "http://192.168.50.242:7000/login"
    Then I expect the page url is "http://192.168.50.242:7000/payment"
    And I expect the element "h1" contains text "Add a payment method"
  ...
  Scenario: Add method, show error, fix and redirect to SaaS
    Given I open the url "http://192.168.50.242:7000/payment"
    And I expect the element "h1" contains text "Add a payment method"
    And I expect the element "[type='submit']" contains text "Pay $49/mo"
    And I wait for 1 seconds

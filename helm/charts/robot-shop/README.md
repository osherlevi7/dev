...
Use this helm chart to customise your install of Osher's Robot Shop.
...
```shell
$ helm install --set image.repo=privateRepo.io/repoName ...
```
Will pull images from your private repo.
